...
The main learning this week is that adding more labeled reviews .

After adding 40 more reviews, the TF-IDF baseline still struggled with some labels, especially `homework_heavy`.
...
* Moataz Abdelaziz (Product): Fixed the course-signal pipeline, added low-evidence warnings, added tests, updated the report/demo flow. (evidence:issue #42, PR #43)
