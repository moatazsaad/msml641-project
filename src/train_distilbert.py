...
def main():
    ...
    # Same idea as TF-IDF's class_weight="balanced": weight each label's positive
    # class inversely to how rare it is, so the loss doesn't just learn to predict
    # "0" for imbalanced labels like project_heavy.
